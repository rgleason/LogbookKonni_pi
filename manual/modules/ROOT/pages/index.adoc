...
* Maintenance Source: https://github.com/rgleason/LogBookKonni_pi rgleason
* Source: https://github.com/delatbabel/LogbookKonni-1.2[Github
Repository - Delatbabel]
* Old Source: https://github.com/ptulp/LogbookKonni_pi[Github Repository -
Peter Tulp used to maintain the plugin]
...
https://opencpn.org/wiki/dokuwiki/lib/exe/fetch.php?media=opencpn:files:logbook1.2-help.pdf[Logbook1.2-help.pdf]

https://opencpn.org/wiki/dokuwiki/lib/exe/fetch.php?media=opencpn:files:logbook1.2-help.doc[Logbook1.2-help.doc]

https://opencpn.org/wiki/dokuwiki/lib/exe/fetch.php?media=opencpn:files:logbook_help_conversion.docx[Logbook_help_conversion.docx]
