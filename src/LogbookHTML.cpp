...
void LogbookHTML::setPlaceholders()
{
    ...
    if ( parent->logGrids[0]->GetNumberRows() > 0 )
    {
        ...
        placeholdersboat["EDATE"]        = parent->m_gridGlobal->GetCellValue( parent->m_gridGlobal->GetNumberRows()-1,1 );
    }
...
wxString LogbookHTML::toHTML( wxString path, wxString layout, bool mode )
{
    ...
    if ( !checkLayoutError( indexHeaderBottom,seperatorHeaderBottom,layout ) ) return "";
    ...
    topHTML.Replace( "#EDATE#",parent->m_gridGlobal->GetCellValue(
...
wxString LogbookHTML::replacePlaceholder( wxString html,wxString htmlHeader,int grid, int row, int col, bool mode, wxTextOutputStream &htmlFile )
{
    ...
    case 0:
        ...
        case ROUTE:
            ...
            {
                htmlHeader.Replace( "#ROUTE#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ) );
                htmlHeader.Replace( "#LROUTE#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
                htmlFile << htmlHeader;
            }
            ...
            break;
        case RDATE:
            html.Replace( "#DATE#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LDATE#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            html.Replace( "#NO.#",wxString::Format( "%i",row+1 ) );
            break;
        case RTIME:
            html.Replace( "#TIME#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LTIME#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case STATUS:
            html.Replace( "#STATUS#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LSTATUS#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WAKE:
            html.Replace( "#WAKE#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWAKE#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case DISTANCE:
            html.Replace( "#DISTANCE#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LDISTANCE#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case DTOTAL:
            html.Replace( "#DTOTAL#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LDTOTAL#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case POSITION:
            html.Replace( "#POSITION#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LPOSITION#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case COG:
            html.Replace( "#COG#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LCOG#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case COW:
            html.Replace( "#COW#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LCOW#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case SOG:
            html.Replace( "#SOG#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LSOG#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case SOW:
            html.Replace( "#SOW#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LSOW#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case DEPTH:
            html.Replace( "#DEPTH#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LDEPTH#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case REMARKS:
            html.Replace( "#REMARKS#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LREMARKS#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        }
        break;
    case 1:
        ...
        {
        case BARO:
            html.Replace( "#BARO#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LBARO#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case HYDRO:
            html.Replace( "#HYDRO#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LHYDRO#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case AIRTE:
            html.Replace( "#AIRTE#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LAIRTE#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WATERTE:
            html.Replace( "#WTE#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWTE#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WIND:
            html.Replace( "#WIND#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWIND#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WSPD:
            html.Replace( "#WSPD#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWSPD#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WINDR:
            html.Replace( "#WINDR#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWINDR#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WSPDR:
            html.Replace( "#WSPDR#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWSPDR#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case CURRENT:
            html.Replace( "#CUR#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LCUR#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case CSPD:
            html.Replace( "#CSPD#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LCSPD#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WAVE:
            html.Replace( "#WAVE#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWAVE#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case SWELL:
            html.Replace( "#SWELL#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LSWELL#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WEATHER:
            html.Replace( "#WEATHER#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWEATHER#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case CLOUDS:
            html.Replace( "#CLOUDS#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ) );
            html.Replace( "#LCLOUDS#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ) );
            {
            ...
            break;
        case VISIBILITY:
            html.Replace( "#VISIBILITY#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LVISIBILITY#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        }
        break;
    case 2:
        ...
        {
        case MOTOR:
            html.Replace( "#MOTOR#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LMOTOR#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case MOTORT:
            html.Replace( "#MOTORT#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LMOTORT#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case RPM1:
            html.Replace( "#RPM1#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LRPM1#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case MOTOR1:
            html.Replace( "#MOTOR1#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LMOTOR1#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case MOTOR1T:
            html.Replace( "#MOTOR1T#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LMOTOR1T#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case RPM2:
            html.Replace( "#RPM2#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LRPM2#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case FUEL:
            html.Replace( "#FUEL#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LFUEL#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case FUELT:
            html.Replace( "#FUELT#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LFUELT#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case GENE:
            html.Replace( "#GENE#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LGENE#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case GENET:
            html.Replace( "#GENET#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LGENET#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case BANK1:
            html.Replace( "#BANK1#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LBANK1#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case BANK1T:
            html.Replace( "#BANK1T#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LBANK1T#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case BANK2:
            html.Replace( "#BANK2#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LBANK2#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case BANK2T:
            html.Replace( "#BANK2T#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LBANK2T#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case SAILS:
            html.Replace( "#SAILS#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LSAILS#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case REEF:
            html.Replace( "#REEF#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LREEF#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WATERM:
            html.Replace( "#WATERM#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWATERM#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WATERMT:
            html.Replace( "#WATERMT#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWATERMT#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WATERMO:
            html.Replace( "#WATERMO#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWATERMO#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WATER:
            html.Replace( "#WATER#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWATER#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case WATERT:
            html.Replace( "#WATERT#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LWATERT#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        case MREMARKS:
            html.Replace( "#MREMARKS#",Export::replaceNewLine( mode,g->GetCellValue( row,col ),false ),false );
            html.Replace( "#LMREMARKS#",Export::replaceNewLine( mode,g->GetColLabelValue( col ),true ),false );
            break;
        }
        break;
    }
...
void LogbookHTML::viewODT( wxString path, wxString layout, bool mode )
{
    ...
    if ( file != "" )
        parent->startApplication( file,".odt" );
}
...
wxString LogbookHTML::toODT( wxString path,wxString layout, bool mode )
{
    ...
    odt.Replace( "#EDATE#",parent->m_gridGlobal->GetCellValue( parent->m_gridGlobal->GetNumberRows()-1,1 ),false );
...
void LogbookHTML::toXML( wxString path )
{
    ...
    for ( int row = 0; row < parent->m_gridGlobal->GetNumberRows(); row++ )
    {
        xmlFile << wxString::Format( "<Row ss:Height=\"%u\">",parent->m_gridGlobal->GetRowHeight( row ) );
        for ( int grid = 0; grid < parent->numPages; grid++ )
        {
            for ( int col = 0; col < parent->logGrids[grid]->GetNumberCols(); col++ )
            {
...
void LogbookHTML::toKML( wxString path )
{
    wxString datetime, position, description, temp, folder, t, header, logpointName,
             route = "nil" , oldroute, remarks, fRemarks, label, pathXML;
    wxString snil = "---";
    ...
    *kmlFile << h;
    ...
    h.Replace( "#LTRANS#",logbook->opt->kmlTrans.Item( logbook->opt->kmlLineTransparancy ) );
    h.Replace( "#LCOLORR#",logbook->opt->kmlColor.Item( logbook->opt->kmlRouteColor ) );
    h.Replace( "#LCOLORT#",logbook->opt->kmlColor.Item( logbook->opt->kmlTrackColor ) );
    *kmlFile << h;
    ...
    for ( ; row < parent->m_gridGlobal->GetNumberRows(); row++ )
    {
            ...
            for ( int col = 0; col < parent->logGrids[grid]->GetNumberCols(); col++ )
            {
                ...
                else if ( grid == 2 )
                {
                    ...
                    case MREMARKS:
                        ...
                        temp.Replace( "#DESCRIPTION#",description+( ( fRemarks.IsEmpty() )?"":"\n"+fRemarks )+"\n"+e,false );
                        break;
                    case ROUTEID:
                        routeOldID = routeID;
                        routeID = e;
        ...
        if ( !error )
        {
            temp.Replace( "#icon#","http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png" );
            ( *kmlFile ) << temp;
        }
...
void LogbookHTML::writeRouteToKML( wxJSONValue data )
{
    ...
    *kmlFile << routeLine;
    ...
    for ( int i = 0; i < data.Size(); i++ )
        ( *kmlFile ) << wxString::Format( "%f,%f\n",data[i]["lon"].AsDouble(),data[i]["lat"].AsDouble() );
    ...
    *kmlFile << n;
    ...
    for ( int i = 0; i < data.Size(); i++ )
    {
        ...
        routeWP.Replace( "#icon#","http://maps.google.com/mapfiles/kml/pal4/icon48.png" );
        ...
        routeWP.Replace( "#POSITION#",wxString::Format( "%f,%f\n",data[i]["lon"].AsDouble(),data[i]["lat"].AsDouble() ) );
        ( *kmlFile ) << routeWP;
...
/*
          ...
          +					{
          +						temp = in.GetNextLine();
          +						if(temp.Contains("</trk>")) return track;
          +
          ...
          +
          +	if(!ind)
          +		kmlData = findTrackInXML(dt, "navobj.xml.changes", &name, route, trackguid, offset, ind, mode);
          +	else
          +		kmlData = findTrackInXML(dt, "navobj.xml", &name, route, trackguid, offset, ind, mode);
          +
          +	name = route;
          +	if(!kmlData.IsEmpty())
          +	{
